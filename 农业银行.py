...
bank_choice = {"0":"账户类型","1":"开户","2":"存钱","3":"取钱","4":"转账","5":"查询","6":"Bye"}  # 银行业务选项
# 开户成功的信息模板
myinfo='''
    \033[0;32;40m
    ------------账户信息------------
...
def zhanghuleixing():
    print("A:金卡B:普通卡")
    zhanghu=inputHelp("请输入你的账户类型")
    z=bank_zhnghuleixing(zhanghu)
    if z==1:
        bank_choice["0"]="金卡"
    if z==2:
        bank_choice["0"]="普通卡"
...
def bank_zhnghuleixing(zhanghu):
    if zhanghu=="A":
        return 1
    elif zhanghu=="B":
        return 2
# 获取随机码
def  getRandom():
  zha_h=random.randint(10000000,99999999)
  zha_h=int(zha_h)
  return zha_h
# 通过账号获取账户信息
